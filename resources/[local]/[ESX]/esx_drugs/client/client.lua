CreateThread(function()
	...
	RegisterNetEvent('skrrrt:esx_dragi_config')
	AddEventHandler('skrrrt:esx_dragi_config', function(cossa)
		Config.Zones = cossa
	end)

	RegisterNetEvent('skrrrt:esx_dragi_eventchanger')
	AddEventHandler('skrrrt:esx_dragi_eventchanger', function(eve1, eve2, eve3, eve4, eve5, eve6, eve7, eve8, eve9)
		event1 = eve1
		event2 = eve2
		event3 = eve3
		event4 = eve4
	...
	AddEventHandler('esx_drugs:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, weedNbr, weedpNbr, heroinaNbr, heroinapNbr, jobName, currentZone)
		cokeQTE	   = cokeNbr
