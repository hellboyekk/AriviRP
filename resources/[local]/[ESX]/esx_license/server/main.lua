...
function RemoveLicense(target, type, cb)
	...
	givelicka('AriviRP.pl', wiadomosc, 11750815)
...
function deltelicka(hook,message,color)
  local gigafajnywebhook223 = 'https://discord.com/api/webhooks/811371869881368577/jIhEBSO1gMuSaRFvw653tJC9bJrTfIvKYj98WNcB_2haxN4LQPGKRE1Rb_E5HtkwIWOZ'
  local embeds = {
              {
          ["title"] = message,
          ["type"] = "rich",
