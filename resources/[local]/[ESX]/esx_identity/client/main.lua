...
RegisterNUICallback('JEBACTUSKAKURWEFAJNYJESTEMREJESTRACJAPOSTACIHEREJSDJHASHDADASZUBIENICAPESTYCYDYBRONHEREXDDDDDDDDDKARTKYKOCHAMCIE', function(data, cb)
    ...
    if reason == "" then
        ...
        EnableGui(false)
        ESX.Scaleform.ShowFreemodeMessage('~o~AriviRP.pl', 'Ustaw się w dogodnym miejscu, za 30 sekund uruchomi się menu tworzenia postaci.', 10)
        Wait(200)
        ESX.Scaleform.ShowFreemodeMessage('~o~AriviRP.pl', 'Ustaw się w dogodnym miejscu, za 20 sekund uruchomi się menu tworzenia postaci.', 10)
        Wait(200)
        ESX.Scaleform.ShowFreemodeMessage('~o~AriviRP.pl', 'Ustaw się w dogodnym miejscu, za 10 sekund uruchomi się menu tworzenia postaci.', 10)
        Wait(200)
        ESX.ShowAdvancedNotification('~o~AriviRP.pl', nil, 'Menu tworzenia postaci zostało otworzone.', 'CustomLogo')
