...
RegisterNetEvent('Arivi:PrintClientLsCustom')
AddEventHandler('Arivi:PrintClientLsCustom', function()
	print('Wystąpił problem z twoim tuningowaniem pojazdu - Twoja tablica rejestracyjna została wykryta jako NIL zgłoś się proszę do administracji.')
end)
