...
Config.MarkerColor          = {r = 17, g = 255, b = 0}
Config.MarkerColorImpound   = {r = 255, g = 0, b = 0}
...
Config.Garages = {
	...
	{
		Marker  = vector3(979.88, -226.56, 68.83),
		Blip	= true,
		Job = {}
	},
	{
		Marker  = vector3(1366.50, -579.83, 73.43),
		Blip	= true,
		Job = {}
	},
	{
	...
	{
		Marker 	= vector3(1027.49, -777.0, 58.04-0.90),
		Blip	= true,
		Job = {}
	},
	{
	...
	{
		Marker  = vector3(150.63, 6606.92, 31.85-0.95),
		Blip	= true,
		Job = {}
	},
	{
		Marker  = vector3(-1899.44, -560.99, 11.79-0.90),
		Blip	= true,
		Job = {}
	},
	{
		Marker  = vector3(1122.64, 2660.0, 37.0),
		Blip	= true,
		Job = {}
	},
	{
	...
	{
		Marker  = vector3(256.1321, -773.820, 30.67-0.90),
		Blip	= true,
		Job = {}
	},
	{
	...
	{
		Marker  = vector3(-191.46, -1284.61, 30.33),
		Blip	= true,
		Job = {}
	},
	{
		Marker 	= vector3(362.26, 2636.29, 44.49-0.90),
		Blip	= true,
		Job = {}
	},
	{
		Marker 	= vector3(-76.31, 6337.28, 31.49-0.90),
		Blip	= true,
		Job = {}
	},
	{
	...
	-- NO BLIP
	{
		Marker  = vector3(719.58, -823.31, 15.28),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(-107.29, 836.17, 234.69),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(-2345.13, 290.72, 168.50),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(-235.17, -1472.97, 30.47),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(-414.0, 1207.26, 324.67),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(673.65, 615.41, 127.94),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(-69.68, -2011.86, 17.05),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(893.36, -1019.50, 33.97),
		Blip	= false,
		Job = {}
	},
	{
	...
	{
		Marker  = vector3(380.51, -752.58, 29.29-0.95),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(324.89, -2031.29, 19.99),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(129.34, -1072.12, 28.25),
		Blip	= false,
		Job = {}
	},
	{
	...
	{
		Marker 	= vector3(495.29, -1326.32, 28.32),
		Blip	= false,
		Job = {}
	},
	{
		Marker 	= vector3(-25.27, -1427.18, 29.70),
		Blip	= false,
		Job = {}
	},
	{
		Marker 	= vector3(-2612.05, 1685.18, 140.93),
		Blip	= false,
		Job = {}
	},
	{
		Marker 	= vector3(22.36, 544.22, 175.1),
		Blip	= false,
		Job = {}
	},
	{
	...
	{
		Marker  = vector3(-58.47, -1843.36, 26.53-0.90),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(250.65, -1068.51, 28.3),
		Blip	= false,
		Job = {}
	},
	{
		Marker  = vector3(-3203.82, 843.35, 7.93),
		Blip	= false,
		Job = {}
	},
	-- JOBS
	{
		...
		Blip	= false,
		Job = {'police', 'offpolice', 'ambulance', 'offambulance'}
	},
	{
	...
	{
		Marker  = vector3(459.23, -990.0, 24.80),
		Blip	= false,
		Job = {'police', 'offpolice'}
	},
	{
		Marker  = vector3(459.23, -995.19, 24.80),
		Blip	= false,
		Job = {'police', 'offpolice'}
	},
	{
		Marker  = vector3(-811.90, 187.37, 71.47),
		Blip	= false,
		Job = {'taxi'}
	},
	{
		Marker = vector3(-315.03, -734.24, 27),
		Blip = false,
		Job = {}
	},
	{
		Marker = vector3(-654.72, 308.63, 82.42),
		Blip = false,
		Job = {}
	},
	{
		Marker = vector3(1881.45, 3814.98, 31.78),
		Blip = false,
		Job = {}
	}
}
...
Config.Impound = {
	vector3(495.96, -1339.87, 28.35),
	vector3(110.48, 6625.50, 30.79)
}
...
Config.Contract = {
	vector3(-551.6007, -190.2991, 37.2697),
}
