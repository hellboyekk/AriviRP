...
function RefreshBussHUD()
	...
	if ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'urzednik6' or ESX.PlayerData.job.grade_name == 'zcadyrektora' or ESX.PlayerData.job.grade_name == 'zcakomenda' or ESX.PlayerData.job.grade_name == 'uber' or ESX.PlayerData.job.grade_name == 'kierownik' or  ESX.PlayerData.job.grade_name == 'kapitan3' then
...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'urzednik6' or ESX.PlayerData.job.grade_name == 'zcadyrektora' or ESX.PlayerData.job.grade_name == 'zcakomenda' or ESX.PlayerData.job.grade_name == 'kierownik' or  ESX.PlayerData.job.grade_name == 'kapitan3' and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)
...
function OpenBossMenu(society, close, options)
	...
	if options.showmoney then
		table.insert(elements, {label = 'Stan konta frakcji: <span style="color:limegreen;">'..fractionAccount..'$', value = 'none'})
	end
...
function OpenBossMenu2(society, close, options)
	...
	ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
		fractionAccount = money
		moneyLoaded = true
	end, ESX.PlayerData.hiddenjob.name)
	...
	if options.showmoney then
		table.insert(elements, {label = 'Saldo <span style="color:green;">'..fractionAccount..'$' , value = 'none'})
	end
...
function OpenEmployeeList2(society)
  ...
  ESX.TriggerServerCallback('esx_society:getEmployees2', function(employees)
    ...
    for i=1, #employees, 1 do
	    if employees[i].hiddenjob_grade == 0 then
	      table.insert(elements.rows, {
	        data = employees[i],
	        cols = {
	          employees[i].name,
...
function OpenPromoteMenu2(society, employee)
		...
		table.insert(elements, {label = 'Rekrut', value = 0, selected = (0)})
		table.insert(elements, {label = 'Nowicjusz', value = 1, selected = (1)})
		table.insert(elements, {label = 'Doświadczony', value = 2, selected = (2)})
		table.insert(elements, {label = 'Kapitan', value = 3, selected = (3)})
		table.insert(elements, {label = 'Doradca', value = 4, selected = (4)})
		table.insert(elements, {label = 'Szef', value = 5, selected = (5)})
...
AddEventHandler('esx_society:organisationmenu', function(society)
	OpenManageEmployeesMenu2(society)
end)
